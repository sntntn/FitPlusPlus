<template>
  ...
  export default {
        ...
        trainers: [
          {
            ...
            messages: [
              ...
              { id: 2, text: "Hi, I have a question.", sender: "client" },
            ],
          },
          {
            id: 2,
            name: "Trainer 2",
            messages: [
              { id: 3, text: "When is your availability?", sender: "trainer" },
              { id: 4, text: "I am free tomorrow.", sender: "client" },
            ],
          },
        ],
    ...
    created() {
      // Automatski odaberi prvog trenera prilikom inicijalizacije
